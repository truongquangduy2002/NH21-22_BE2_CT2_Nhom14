            ...
            <!-- <div class="bg-light p-4 mb-30">
                <form>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input" value="" id="">
                        <label class="custom-control-label" for="price-1"></label>
                        <span class="badge border font-weight-normal for=""></span>
                    </div>
                </form>
            </div> -->
            <!-- Price End -->
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="img/{{$row->image}}" alt="">
